...
<body>
    ...
    <div class="rectangle">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control form1 fa fa-user" id="empID" placeholder="&#xf007; Admin ID">
        </div>
        <div class="form-group">
            <label for="empname" class="label2">Username</label>
            <input type="text" class="form-control form2 fa fa-user" id="empname" placeholder="&#xf007; Username">
        </div>
        <div class="form-group">
            <label for="epass" class="label3">Password</label>
            <input type="text" class="form-control form3 fa fa-key" id="epass" placeholder="&#xf084; Password">
        </div>
